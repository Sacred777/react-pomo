...
export function Content() {
  return (
    <>
      <Text As={'h2'} size={24} weight={EWeight.bold} lineHeight={33}color={EColors.grey33}>Ура! Теперь можно начать работать:</Text>
      <Break size={5} top />
      <ul className={styles.list}>
        <Text As={'li'} size={16} lineHeight={33} color={EColors.grey33}>Выберите категорию и напишите название текущей задачи</Text>
